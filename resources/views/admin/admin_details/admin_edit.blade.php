   ...
   <div class="container-fluid">
       ...
       <div class="row">
           <div class="col-md-12 mt-2">
                <form data-parsley-validate="" id="validate_form" style="font-size: 15px;padding-left:15px; padding-right:15px; border: 1px solid rgb(132, 136, 138)" action="{{route('updateRole',$data->id)}}" method="POST" enctype="multipart/form-data">
                    <br>
